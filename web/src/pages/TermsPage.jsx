...
export default function TermsPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Kullanım Şartları | DosyaHub</title>
        <meta
          name="description"
          content="DosyaHub kullanım koşulları, yasal sorumluluklar ve hizmet şartları hakkında detaylı bilgi."
        />
      </Helmet>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="relative group rounded-[2.5rem] border border-white/10 bg-white/[0.03] backdrop-blur-xl p-8 md:p-12 shadow-2xl overflow-hidden text-sm md:text-base text-zinc-400 space-y-8 leading-relaxed">
            ...
            <section>
              ...
              <p>
                Kullanıcılar, sistemi kötüye kullanmayacaklarını taahhüt
                ederler. Bir dosya için belirlenen 50MB sınırının aşılması veya
                sunuculara aşırı yük bindirecek toplu işlemler yapılması hizmete
            ...
            <section>
              ...
              <p>
                DosyaHub arayüzü, logoları ve yazılım altyapısı DosyaHub'a
                aittir. Kullanıcıların yüklediği dosyalar üzerinde DosyaHub
                herhangi bir hak iddia etmez; mülkiyet tamamen kullanıcıya
                aittir.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Bu şartlar zaman zaman güncellenebilir. Platformu kullanmaya
