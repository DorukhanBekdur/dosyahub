  ...
  return (
    <section className="relative mx-auto max-w-6xl px-4 py-16">
      ...
      <div className="grid lg:grid-cols-2 gap-10 items-stretch">
        <div className="relative flex flex-col justify-between rounded-2xl rounded-t-none border border-zinc-200/70 dark:border-zinc-800/70 bg-white/80 dark:bg-zinc-900/70 p-6 md:p-8 shadow-sm">
